...
#else /* << EST */
        UTIL2_strcatPad((uint8_t*)pcWriteBuffer, bufSize, (const unsigned char*)pxTaskStatusArray[ x ].pcTaskName, ' ', configMAX_TASK_NAME_LEN);
	      UTIL2_strcat((uint8_t*)pcWriteBuffer, bufSize, (const unsigned char*)"\t");
	      UTIL2_chcat((uint8_t*)pcWriteBuffer, bufSize, (unsigned char)cStatus);
	      UTIL2_chcat((uint8_t*)pcWriteBuffer, bufSize, (unsigned char)'\t');
	      UTIL2_strcatNum32u((uint8_t*)pcWriteBuffer, bufSize, pxTaskStatusArray[ x ].uxCurrentPriority);
	      UTIL2_chcat((uint8_t*)pcWriteBuffer, bufSize, (unsigned char)'\t');
	      UTIL2_strcatNum32u((uint8_t*)pcWriteBuffer, bufSize, pxTaskStatusArray[ x ].usStackHighWaterMark);
	      UTIL2_chcat((uint8_t*)pcWriteBuffer, bufSize, (unsigned char)'\t');
	      UTIL2_strcatNum32u((uint8_t*)pcWriteBuffer, bufSize, pxTaskStatusArray[ x ].xTaskNumber);
	      UTIL2_strcat((uint8_t*)pcWriteBuffer, bufSize, (const unsigned char*)"\r\n");
#endif
			}
		...
		*pcWriteBuffer = 0x00;
		...
		if( pxTaskStatusArray != NULL )
		{
          ...
          UTIL2_strcatPad((uint8_t*)pcWriteBuffer, bufSize, (const unsigned char*)pxTaskStatusArray[ x ].pcTaskName, ' ', configMAX_TASK_NAME_LEN);
...
#else /* << EST */
              UTIL2_strcat((uint8_t*)pcWriteBuffer, bufSize, (const unsigned char*)"\t");
              UTIL2_strcatNum32u((uint8_t*)pcWriteBuffer, bufSize, pxTaskStatusArray[ x ].ulRunTimeCounter);
              UTIL2_strcat((uint8_t*)pcWriteBuffer, bufSize, (const unsigned char*)"\t\t");
              UTIL2_strcatNum32u((uint8_t*)pcWriteBuffer, bufSize, ulStatsAsPercentage);
              UTIL2_strcat((uint8_t*)pcWriteBuffer, bufSize, (const unsigned char*)"%\r\n");
#endif
						}
						#endif
              ...
              UTIL2_strcat((uint8_t*)pcWriteBuffer, bufSize, (const unsigned char*)"\t");
              UTIL2_strcatNum32u((uint8_t*)pcWriteBuffer, bufSize, pxTaskStatusArray[ x ].ulRunTimeCounter);
              UTIL2_strcat((uint8_t*)pcWriteBuffer, bufSize, (const unsigned char*)"\t\t<1%\r\n");
#endif
						}
						#endif
					}
